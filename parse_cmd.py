...
cmd_add_or_edit.add_argument('--hide', '-i', action='store_const', const=0, dest='is_hidden')
...
cmd_add_or_edit.add_argument('--unhide', '-u', action='store_const', const=1, dest='is_hidden')
